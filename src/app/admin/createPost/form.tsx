...
const CreatePostForm: React.FunctionComponent<Props> = ({
  categorys,
  user,
}) => {
  ...
  const [formShownLocalStorage, setformShownLocalStorage] = useLocalStorage({
    key: "formOpened",
    initialValue: false,
  });
  ...
  const [currStepLocalStorage, setCurrStepLocalStorage] = useLocalStorage({
    key: "currStep",
    initialValue: 0,
  });
  ...
  if (!formShown) {
    return (
      <div>
        <h1 className="font-bold mt-5 mb-5 text-2xl">
          Započni sa kreiranjem novog članka!
        </h1>
        <div className="w-min mb-5">
          <div>
            <Link
              href={`/profile`}
              className="flex flex-col bg-card py-4 px-3 lg:px-7 rounded-md w-full md:max-w-md"
            >
        ...
        <Button
          className="font-bold h-[45px] w-full md:max-w-md"
          onClick={() => setFormShown(true)}
          variant={"default"}
        >
          Započni sa pisanjem novog članka!
        </Button>
      </div>
    );
  }
          ...
          {sections.map((section) => (
            <div
              ...
              className={`${
                currStep === section.id &&
                "text-red-600" &&
                "border-solid border-t-[1px] border-primary bg-card"
              } ${
                currStep >= section.id &&
                "border-solid border-t-[1px] border-primary"
              } flex-[1] justify-center flex cursor-pointer hover:bg-secondary transition`}
              key={section.id}
            >
              <p
                className={`pt-5 pb-5 ${
                  currStep === section.id && "text-white font-bold"
                } text-gray-400 text-xs lg:text-sm`}
              >
                {section.name}
              </p>
            </div>
                  ...
                  <FormItem className="mt-5">
                    ...
                    <FormControl className="h-12">
                      <Input
                        ...
                        placeholder="Definiši naslov članka"
                        {...field}
                      />
                    </FormControl>
                  ...
                  <FormItem>
                    ...
                    <FormControl className="h-12">
                      <Textarea
                        ...
                        placeholder="Definiši podnaslov članka"
                        {...field}
                      />
                    </FormControl>
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem className="mt-5">
                    ...
                    <FormDescription className="text-sm text-gray-500">
                      *Ako navedete izvor umjesto autora biće prikazan izvor.
                      Ako nema izvora bice prikazan autor
                    </FormDescription>
                    <FormMessage style={{ color: "red" }} />
                  </FormItem>
                )}
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem className="mt-5">
                    ...
                    <FormControl className="h-12">
                      <Input
                        placeholder="Definiši izvor porijekla fotografije"
                        {...field}
                      />
                    </FormControl>
                    <FormMessage style={{ color: "red" }} />
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem className="mt-3">
                      ...
                      <Input
                        disabled
                        placeholder="Prvo kategorija mora biti selektovana"
                      />
                      <FormMessage />
                    </FormItem>
                  )}
          ...
          {currStep === 3 && (
            <div className="mt-10">
              <PostCreationPreview
                ...
                category={
                  categorys.filter((category) => category.id === categoryId)[0]
                }
                categoryHex={
                  categorys.filter((category) => category.id === categoryId)[0]
                    .hexCol as string
