...
<div className='flex flex-col mt-10'>
    <Link className='underline text-primary' href={''}>Instagram</Link>
    <Link className='underline text-primary' href={''}>Facebook</Link>
    <Link className='underline text-primary' href={''}>TikTok</Link>
    <Link className='underline text-primary' href={''}>Youtube</Link>
    <Link className='underline text-primary' href={''}>X</Link>
</div>
